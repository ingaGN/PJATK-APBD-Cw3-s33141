...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie03_StudenciPosortowani()
    {
        return DaneUczelni.Studenci.OrderBy(student => student.Nazwisko)
            ...
            .Select(student => $"{student.Id}, {student.Nazwisko}, {student.Imie}");
    }
    ...
    {
        var p = DaneUczelni.Przedmioty.FirstOrDefault(przedmiot => przedmiot.Kategoria == "Analytics");

        if (p == null)
            return new[] { "nie ma przedmiotu Analitycnzego" };
    ...
    {
        var wartosc =  DaneUczelni.Zapisy
            .Where(zapis => zapis.CzyAktywny == false);
    ...
    {
        bool wynik = DaneUczelni.Prowadzacy.All(prowadzacy => !string.IsNullOrWhiteSpace(prowadzacy.Katedra));
    ...
    {
        int count = DaneUczelni.Zapisy.Count(zapis => zapis.CzyAktywny );
    ...
    public IEnumerable<string> Zadanie08_UnikalneMiastaStudentow()
    {
        return DaneUczelni.Studenci
            ...
            .Distinct().OrderBy(miast0 => miast0);
    }
    ...
    {
        return DaneUczelni.Przedmioty.OrderBy(przedmiot => przedmiot.Nazwa)
    ...
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy, student => student.Id,
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Studenci
            .Join(DaneUczelni.Zapisy, student => student.Id
                , zapis => zapis.StudentId, (student, zapis) => new {student, zapis})
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            ...
            .Join(
                ...
                (zapis, przedmiot) => new
                {
                    przedmiot.Nazwa, OcenaKoncowa = zapis.OcenaKoncowa.Value
                }
            )
            .GroupBy(x => x.Nazwa)
            .Select(grupa => $"{grupa.Key}, {grupa.Average(x => x.OcenaKoncowa):0.00}");
    }
        ...
        return DaneUczelni.Prowadzacy
            ...
            .Select(x => new
            {
                ...
                Oceny = x.przedmioty
                    ...
                    .Where(ocena => ocena != null)
                    .ToList()
            })
            .Select(x => $"{x.Imie} {x.Nazwisko} - {(x.Oceny.Any() ? x.Oceny.Average()!.Value.ToString("F2") : "brak ocen")}");
    }
